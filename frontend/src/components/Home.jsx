...
const Home = () => {
  ...
  return (
    <div className="h-screen w-screen relative flex items-center justify-center">
      ...
      <div className="overlay absolute py-3 pb-[5vw] px-5 h-full w-full flex flex-col items-center justify-between">
        <div className="top">
        ...
        <div className="bottom w-full flex gap-2">
          <div className="left relative active:scale-97 transition-all ease-in-out duration-150 w-1/2 bg-blue-200 flex flex-col items-start justify-between gap-10 p-3 rounded-2xl">
          ...
          <div className="right w-1/2 h-full flex flex-col gap-2">
            <div
              onClick={botchat}
              className="top active:scale-97 transition-all ease-in-out duration-150 w-full h-1/2 rounded-2xl bg-purple-200 p-3"
            >
              <i className="ri-chat-ai-line text-xl"></i>
              <h3 className="font-semibold">Chat with Bot</h3>
            </div>
            <div className="bottom relative active:scale-97 transition-all ease-in-out duration-150 w-full h-1/2 rounded-2xl bg-pink-200 p-3">
